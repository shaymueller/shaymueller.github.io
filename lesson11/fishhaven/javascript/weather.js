...
//current weather api
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&appid=622186510fc74294c33f85507b2fa3a6&units=imperial"
fetch(apiURL)
...
// 5 day forecast
const apiURLforecast = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=622186510fc74294c33f85507b2fa3a6&units=imperial"
...
fetch(towninfoURL)
    ...
    .then(function (jsonObject) {
        ...
        for (let i = 0; i < [1]; i++) {
            ...
            a.textContent = towns[2].events[0];
            b.textContent = towns[2].events[1];
            c.textContent = towns[2].events[2];
            d.textContent = towns[2].events[3];
            event.appendChild(a);
            event.appendChild(b);
            event.appendChild(c);
            event.appendChild(d);
